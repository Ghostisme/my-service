...
var ErrorRoleDelFail = NewError(500109, "删除角色失败")
var ErrorRoleCreateFail = NewError(500200, "创建角色失败")
var ErrorUserCreateFail = NewError(500201, "创建用户失败")
var ErrorUserUpdateFail = NewError(500202, "更新用户失败")
var ErrorUserDelFail = NewError(500203, "删除用户失败")
var ErrorCreateCodeFail = NewError(500204, "创建验证码失败")
var ErrorValidCodeFail = NewError(500205, "验证码错误")
var ErrorRegisterFail = NewError(500206, "注册失败")
